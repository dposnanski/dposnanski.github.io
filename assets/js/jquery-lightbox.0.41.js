...
(function ($) {
  $.fn.lightBox = function () {
    ...
    function resizeX(oImage) {
      ...
      iMaxX = iWinX - (getFullWidth($('#lightBox .lb-container')) - iImgX);
    ...
    function resizeY(oImage) {
      ...
      iMaxY = iWinY - (getFullHeight($('#lightBox .lb-container')) - iImgY);
      ...
      $('#lightBox .lb-container').css({
        'top': ($(window).scrollTop() + 30 + ((iWinY - getFullHeight($('#lightBox .lb-container'))) * 0.5)) + 'px'
      });
    }
    ...
    function swapImage(oImages, oImage, iIndex) {
      ...
      if (sOldSrc === oNewImage.href) {} else {
    ...
    function bindEvents(oImages, oImage) {
      ...
      if (typeof (oImage) !== 'undefined') {
        ...
        $(document).on('click tap', '.lb-container', function (event) {
          event.stopPropagation(); /* make sure clicking on .lb-container doesn't trigger click on #overlay */
        });
    ...
    function init() {
      ...
      if (!document.getElementById('lightBox')) {
        $('body').append('<div id="overlay"></div><div id="lightBox"><span class="lb-container"><span class="image"><a href="javascript:void(0);" id="closeBtn"></a><a href="javascript:void(0);" id="nextImage" class="navigatory"></a><a href="javascript:void(0);" id="prevImage" class="navigatory"></a></span><span class="data"></span></span></div>');
        oImage = new Image();
